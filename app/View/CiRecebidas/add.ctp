...
<div class="row">
    <div class="col-xs-6 col-xs-offset-3">
		<div class="box box-primary">
			...
			<h3 class="box-title"><?php echo __('Nova Ci Recebida'); ?></h3>
			</div>
			...
			<?php echo $this->Form->create('CiRecebida', array('role' => 'form')); ?>
				...
				<fieldset>
					...
					<div class="form-group">
						<?php echo $this->Form->input('procedencia', array('label' => 'Procedência','required', 'class' => 'form-control')); ?>
					</div><!-- .form-group -->
					<div class="form-group">
					...
					<!--<div class="form-group">
						<?php echo $this->Form->input('digitalizacao', array('label' => 'digitalização','class' => 'form-control')); ?>
					</div><!-- .form-group -->
