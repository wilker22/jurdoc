...
<div class="row">
    <div class="col-xs-6 col-xs-offset-3">
		<div class="box box-primary">
			...
			<h3 class="box-title"><?php echo __('Nova CI'); ?></h3>
			</div>
			...
			<?php echo $this->Form->create('Ci', array('role' => 'form')); ?>
				...
				<fieldset>
					...
					<div id="destino" class="form-group">
						<?php echo $this->Form->input('destino', array('class' => 'form-control')); ?>
					</div><!-- .form-group -->
						<div class="form-group">
						<?php echo $this->Form->input('assessore_id', array('label' => 'Assessor', 'class' => 'form-control')); ?>
					</div><!-- .form-group -->
					<div class="form-group">
						<?php echo $this->Form->input('despacho', array('label' => 'Observação', 'class' => 'form-control')); ?>
					</div><!-- .form-group -->
